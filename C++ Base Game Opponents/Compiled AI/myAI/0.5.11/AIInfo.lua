...
local infos = {
	...
	{
		key    = 'version',
		value  = '0.5.11', -- AI version - !This comment is used for parsing!
	},
	{
		key    = 'name',
	...
	{
		key    = 'description',
		value  = 'This AI is for testing the C++ wrapper only. Modified to attempt to load outside information',
		desc   = 'tooltip.',
	},
	{
		key    = 'url',
