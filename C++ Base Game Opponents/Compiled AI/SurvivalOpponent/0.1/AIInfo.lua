...
local infos = {
	...
	{
		key    = 'name',
		value  = 'Opponent for all matches between evaluations (swarming, but not hunting)',
		desc   = 'human readable name.',
	},
	{
		key    = 'description',
		value  = 'Continually spawns units that move between mass points, but do not hunt the player.',
		desc   = 'tooltip.',
	},
	{
		key    = 'url',
