...
local mapinfo = {
	name        = "Value Test 2",
	shortname   = "VALUETEST2",
	description = "Value Test 2 map designed for Metal distance comparisons.",
	author      = "connor.leonie.com",
	version     = "2.0",
	--mutator   = "deployment";
	mapfile   = "maps/Value Test 2.smf", --// location of smf/sm3 file (optional)
	...
	smf = {
		minheight = -60,
		maxheight = 940,
		smtFileName0 = "maps/Value Test 2.smt",
		--smtFileName1 = "",
		--smtFileName.. = "",
		--smtFileNameN = "",
	},
