...
local mapinfo = {
	name        = "ShortestPath",
	shortname   = "SP",
	description = "Shortest Path Test for capstone verification.",
	author      = "connor.leonie.com",
	version     = "2.0",
	--mutator   = "deployment";
	mapfile   = "maps/ShortestPath.smf", --// location of smf/sm3 file (optional)
	...
	smf = {
		minheight = -60,
		maxheight = 940,
		smtFileName0 = "maps/ShortestPath.smt",
		--smtFileName1 = "",
		--smtFileName.. = "",
		--smtFileNameN = "",
	},
