...
local mapinfo = {
	name        = "ComboMap",
	shortname   = "MD2",
	description = "A map for combat training against multiple enemy types.",
	author      = "connor.leonie.com",
	version     = "2.0",
	--mutator   = "deployment";
	mapfile   = "maps/ComboMap.smf", --// location of smf/sm3 file (optional)
	...
	smf = {
		minheight = -60,
		maxheight = 940,
		smtFileName0 = "maps/ComboMap.smt",
		--smtFileName1 = "",
		--smtFileName.. = "",
		--smtFileNameN = "",
	},
