...
local mapinfo = {
	name        = "Survival",
	shortname   = "SVEVENT",
	description = "Survival map designed for ai testing between evaluations.",
	author      = "connor.leonie.com",
	version     = "2.0",
	--mutator   = "deployment";
	mapfile   = "maps/Survival.smf", --// location of smf/sm3 file (optional)
	...
	smf = {
		minheight = -60,
		maxheight = 940,
		smtFileName0 = "maps/Survival.smt",
		--smtFileName1 = "",
		--smtFileName.. = "",
		--smtFileNameN = "",
	},
