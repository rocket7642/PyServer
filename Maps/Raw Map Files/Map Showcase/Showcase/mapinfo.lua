...
local mapinfo = {
	name        = "Showcase",
	shortname   = "SCEVENT",
	description = "The final design, might require multiple implementations depending on the AI remembering.",
	author      = "connor.leonie.com",
	version     = "2.0",
	--mutator   = "deployment";
	mapfile   = "maps/Showcase.smf", --// location of smf/sm3 file (optional)
	...
	smf = {
		minheight = -60,
		maxheight = 940,
		smtFileName0 = "maps/Showcase.smt",
		--smtFileName1 = "",
		--smtFileName.. = "",
		--smtFileNameN = "",
	},
